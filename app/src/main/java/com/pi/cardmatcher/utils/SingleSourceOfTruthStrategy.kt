...
fun <T, A> resultLiveData(databaseQuery: () -> LiveData<T>, networkCall: suspend () -> RepositoryResult<A>,
    saveCallResult: suspend (A) -> Unit): LiveData<RepositoryResult<T>> = liveData(Dispatchers.IO) {
